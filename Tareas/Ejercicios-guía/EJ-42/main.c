...
int main(int argc, char const *argv[])
{
    ...
    do
    {
        ...
        // Sumo los salsrios de los empleados
    ...
    // Calculo el salario_promedio que es la suma_salarios dividido cant_empleados

    salario_promedio = suma_salarios / cant_empleados;
    ...
    printf("SALARIO SEMANAL: %i\n", menor_salario);
    printf("----- INFORME DE LA EMPRESA -----\n");
    printf("COSTO EN SUELDOS: %i\n", suma_salarios);
