...
{
    // HACER UN ALGORITMO QUE ME IMPRIMA LOS NUMEROS PARES DEL 1 AL 100
    ...
    while (contador <= 100)
    {
        // Si el modulo del valor de contador es IGUAL a cero entonces es valor es PAR
        if(contador%2 == 0) {

            // Imprime por pantalla el valor par de contador
            printf("%i\n", contador);
        }
